  ...
  final: [
    {
      ...
      text: 'During the final stage, I progressed from developing individual 3D assets to combining them into a complete forest environment. I refined the tree and tent models, applied textures and materials, organised the assets, and developed the final scene presentation. One challenge was managing the increasing number of models, textures and supporting files as the project developed. I addressed this by separating assets into structured folders and organising the Blender scene using collections and descriptive names. I also focused on improving the presentation of the final assets through lighting, composition and rendered views. This stage helped me understand that technical development is not only about creating assets, but also about keeping the project organised and presenting the development process clearly.',
    },
    {
      ...
      text: 'My actual development was slower than some parts of my original timeline because modelling, texturing and integrating the assets into the final environment required more refinement than initially expected. Rather than continuously adding new complex features, I adjusted the scope to prioritise the core forest experience and the quality of the existing assets. My final timeline therefore focused on asset optimisation, asset management, audio development, final renders, documentation and completion of the online folio. Breaking the final stage into smaller tasks also made the workload more manageable. Comparing my earlier timelines with the final timeline helped me recognise that project schedules need to remain flexible when technical development takes longer than expected.',
    },
    {
    ...
    },
    {
      ...
      text: 'Feedback throughout the project showed me that the final folio needed to demonstrate the development process, rather than only presenting finished assets. I therefore prioritised documenting the stages of modelling, texturing, asset management, audio development and final scene construction. I also improved the organisation of the folio so that the project concept, moodboards, research, development evidence, final assets and reflection could be accessed clearly. Another important adjustment was providing stronger explanations for the purpose of the audio and visual assets instead of simply displaying them. Applying this feedback made the final folio more focused on showing how my decisions developed throughout the project and how the final outcome connects back to the original concept.',
    },
  ],
  sections: [
